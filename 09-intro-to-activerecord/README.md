![Good Morning](https://camo.githubusercontent.com/8686c5147a4b736241bc598f0b7531220d58688b/687474703a2f2f692e696d6775722e636f6d2f3461573879617a2e676966)

## Timeline

* Look briefly at AR project structure - 5 minutes
* Build migrations to create authors and books tables
  * What do we do if we forget a column?
  * How do we see if migrations ran successfully?
* Add models and write some seed data!
  * Add a helper `full_name` method on authors.
* Test a few AR methods in the console.
